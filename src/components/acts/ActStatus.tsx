...
/**
 * Used by admin to confirm moderation decisions
 * @param {ActStatusProps} props – modal state, act ID, status type, and callbacks
 * @returns {JSX.Element} – dialog modal for approving or rejecting suggestions
 */
export default function ActStatus({
  ...
  /**
   * Sends update request to change act status
   * Closes modal and runs success callback if successful
   */
